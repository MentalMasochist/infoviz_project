    ...
    function overview_main_viz() {
      ...
      subject_network_viz(width, height);
      ...
      // author_network_viz(width, height);
    ...
    function trend_viz(width, height) {
    ...
    function subject_network_viz(width, height) {
